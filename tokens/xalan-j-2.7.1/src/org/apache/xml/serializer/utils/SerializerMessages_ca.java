...
SerializerMessages_ca	TokenNameIdentifier
...
,	TokenNameCOMMA
"La clau del missatge ''{0}'' no està a la classe del missatge ''{1}''"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El format del missatge ''{0}'' a la classe del missatge ''{1}'' ha fallat."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"La classe de serialitzador ''{0}'' no implementa org.xml.sax.ContentHandler."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"No s''ha declarat l''espai de noms pel prefix ''{0}''."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"La declaració de l''espai de noms ''{0}''=''{1}'' es troba fora de l''element."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"No s''ha pogut carregar ''{0}'' (comproveu CLASSPATH), ara s''està fent servir els valors per defecte."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"S''ha intentat un caràcter de sortida del valor integral {0} que no està representat a una codificació de sortida especificada de {1}."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"No s''ha pogut carregar el fitxer de propietats ''{0}'' del mètode de sortida ''{1}'' (comproveu CLASSPATH)"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"L''objecte de propietats passat a SerializerFactory no té cap propietat ''{0}''."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"Avís: el temps d''execució de Java no dóna suport a la codificació ''{0}''."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El paràmetre ''{0}'' no es reconeix."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El paràmetre ''{0}'' es reconeix però el valor sol·licitat no es pot establir."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"La cadena resultant és massa llarga per cabre en una DOMString: ''{0}''."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El tipus de valor per a aquest nom de paràmetre és incompatible amb el tipus de valor esperat."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"La destinació de sortida per a les dades que s'ha d'escriure era nul·la."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"S'ha trobat una codificació no suportada."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El node no s'ha pogut serialitzat."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"La secció CDATA conté un o més marcadors d'acabament ']]>'."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"No s'ha pogut crear cap instància per comprovar si té un format correcte o no. El paràmetre del tipus ben format es va establir en cert, però la comprovació de format no s'ha pogut realitzar."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El node ''{0}'' conté caràcters XML no vàlids."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"S''ha trobat un caràcter XML no vàlid (Unicode: 0x{0}) en el comentari."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"S''ha trobat un caràcter XML no vàlid (Unicode: 0x{0}) en les dades d''instrucció de procés."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"S''ha trobat un caràcter XML no vàlid (Unicode: 0x''{0})'' en els continguts de la CDATASection."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"S''ha trobat un caràcter XML no vàlid (Unicode: 0x''{0})'' en el contingut de dades de caràcter del node."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"S''han trobat caràcters XML no vàlids al node {0} anomenat ''{1}''."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"La cadena "--" no està permesa dins dels comentaris."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El valor d''atribut "{1}" associat amb un tipus d''element "{0}" no pot contenir el caràcter ''<''."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"La referència de l''entitat no analitzada "&{0};" no està permesa."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"La referència externa de l''entitat "&{0};" no està permesa en un valor d''atribut."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El prefix "{0}" no es pot vincular a l''espai de noms "{1}"."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El nom local de l''element "{0}" és nul."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El nom local d''atr "{0}" és nul."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El text de recanvi del node de l''entitat "{0}" conté un node d''element "{1}" amb un prefix de no enllaçat "{2}"."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
MsgKey	TokenNameIdentifier
...
,	TokenNameCOMMA
"El text de recanvi del node de l''entitat "{0}" conté un node d''atribut "{1}" amb un prefix de no enllaçat "{2}"."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
}	TokenNameRBRACE
;	TokenNameSEMICOLON
