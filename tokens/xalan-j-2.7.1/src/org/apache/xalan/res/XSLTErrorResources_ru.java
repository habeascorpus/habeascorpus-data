...
XSLTErrorResources_ru	TokenNameIdentifier
...
ER_NO_CURLYBRACE	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка: Скобка '{' недопустима в выражении"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_ATTRIBUTE	TokenNameIdentifier
,	TokenNameCOMMA
"Для {0} указан недопустимый атрибут: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_SOURCENODE_APPLYIMPORTS	TokenNameIdentifier
,	TokenNameCOMMA
"Пустой sourceNode в xsl:apply-imports!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_ADD	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось добавить {0} в {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES	TokenNameIdentifier
,	TokenNameCOMMA
"Пустой sourceNode в handleApplyTemplatesInstruction!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"У {0} должен быть атрибут name"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TEMPLATE_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"Указанный шаблон не найден: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_RESOLVE_NAME_AVT	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось преобразовать имя AVT в xsl:call-template."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REQUIRES_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для {0} должен быть указан атрибут: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MUST_HAVE_TEST_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"{0} должен содержать атрибут ''test''. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_BAD_VAL_ON_LEVEL_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Неверное значение атрибута уровня: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier
,	TokenNameCOMMA
"Имя processing-instruction не может быть равно 'xml'"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier
,	TokenNameCOMMA
"Имя processing-instruction должно быть допустимым именем NCName: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_MATCH_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Если для {0} определен режим, то необходим атрибут match."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_NAME_OR_MATCH_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"У {0} должен быть атрибут name или match."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_RESOLVE_NSPREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось преобразовать префикс пространства имен: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"В xml:space указано недопустимое значение: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_OWNERDOC	TokenNameIdentifier
,	TokenNameCOMMA
"У дочернего узла нет документа-владельца!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ELEMTEMPLATEELEM_ERR	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка ElemTemplateElement: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_CHILD	TokenNameIdentifier
,	TokenNameCOMMA
"Попытка добавить пустого потомка!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_SELECT_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"У {0} должен быть атрибут select."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_TEST_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для xsl:when должен быть задан атрибут 'test'."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для xsl:with-param должен быть задан атрибут 'name'."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_CONTEXT_OWNERDOC	TokenNameIdentifier
...
ER_PROCESS_NOT_SUCCESSFUL	TokenNameIdentifier
,	TokenNameCOMMA
"Xalan: В процессе обнаружены ошибки."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_SUCCESSFUL	TokenNameIdentifier
,	TokenNameCOMMA
"Xalan: Ошибка."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ENCODING_NOT_SUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"Кодировка не поддерживается: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULD_NOT_CREATE_TRACELISTENER	TokenNameIdentifier
,	TokenNameCOMMA
"Невозможно создать TraceListener: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_KEY_REQUIRES_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для xsl:key необходим атрибут 'name'!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_KEY_REQUIRES_MATCH_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для xsl:key необходим атрибут 'match'!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_KEY_REQUIRES_USE_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для xsl:key необходим атрибут 'use'!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REQUIRES_ELEMENTS_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для (StylesheetHandler) {0} требуется атрибут ''elements''!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_PREFIX_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для (StylesheetHandler) {0} отсутствует атрибут ''prefix''"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_BAD_STYLESHEET_URL	TokenNameIdentifier
,	TokenNameCOMMA
"Неверный URL таблицы стилей: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FILE_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"Не найден файл таблицы стилей: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_IOEXCEPTION	TokenNameIdentifier
,	TokenNameCOMMA
"Исключительная ситуация ввода-вывода при обращении к файлу таблицы стилей: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_HREF_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) Не найден атрибут href для {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_STYLESHEET_INCLUDES_ITSELF	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} непосредственно или косвенно ссылается на себя!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSINCLUDE_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка StylesheetHandler.processInclude, {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_LANG_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для (StylesheetHandler) {0} отсутствует атрибут ''lang''"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_CONTAINER_ELEMENT_COMPONENT	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) Неверное положение элемента {0} ?? Отсутствует элемент-контейнер ''component''"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CAN_ONLY_OUTPUT_TO_ELEMENT	TokenNameIdentifier
,	TokenNameCOMMA
"Вывод возможен только в следующие объекты: Element, DocumentFragment, Document или PrintWriter."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESS_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка StylesheetRoot.process"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_UNIMPLNODE_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка UnImplNode: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_SELECT_EXPRESSION	TokenNameIdentifier
...
ER_CANNOT_SERIALIZE_XSLPROCESSOR	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось сериализовать XSLProcessor!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_INPUT_STYLESHEET	TokenNameIdentifier
,	TokenNameCOMMA
"Не указана исходная таблица стилей!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FAILED_PROCESS_STYLESHEET	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка при обработке таблицы стилей!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULDNT_PARSE_DOC	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось проанализировать документ {0} !"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULDNT_FIND_FRAGMENT	TokenNameIdentifier
,	TokenNameCOMMA
"Не найден фрагмент: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NODE_NOT_ELEMENT	TokenNameIdentifier
,	TokenNameCOMMA
"Узел, на который ссылается идентификатор фрагмента, не является элементом: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"У for-each должен быть атрибут match или name"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"У templates должен быть атрибут match или name"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_CLONE_OF_DOCUMENT_FRAG	TokenNameIdentifier
,	TokenNameCOMMA
"Отсутствует копия фрагмента документа!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_CREATE_ITEM	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось создать элемент дерева результатов: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XMLSPACE_ILLEGAL_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"Задано недопустимое значение xml:space в исходном XML: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_XSLKEY_DECLARATION	TokenNameIdentifier
,	TokenNameCOMMA
"Отсутствует объявление xsl:key для {0}!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_CREATE_URL	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка! Не удалось создать URL для {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XSLFUNCTIONS_UNSUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:functions не поддерживается"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSOR_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка XSLT TransformerFactory"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_ALLOWED_INSIDE_STYLESHEET	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} недопустим в таблице стилей!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_RESULTNS_NOT_SUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"result-ns больше не поддерживается!  Используйте xsl:output."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DEFAULTSPACE_NOT_SUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"default-space больше не поддерживается!  Используйте xsl:strip-space или xsl:preserve-space."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INDENTRESULT_NOT_SUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"indent-result больше не поддерживается!  Используйте xsl:output."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) Для {0} указан недопустимый атрибут: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_UNKNOWN_XSL_ELEM	TokenNameIdentifier
,	TokenNameCOMMA
"Неизвестный элемент XSL: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_BAD_XSLSORT_USE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xsl:sort может применяться только с xsl:apply-templates или xsl:for-each."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISPLACED_XSLWHEN	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) Неверное положение xsl:when!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xsl:when не имеет предшествующего xsl:choose!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISPLACED_XSLOTHERWISE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) Неверное положение xsl:otherwise!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xsl:otherwise не имеет предшествующего xsl:choose!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_ALLOWED_INSIDE_TEMPLATE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} недопустим в шаблоне!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_UNKNOWN_EXT_NS_PREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) Неизвестный префикс {1} пространства имен расширения {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_IMPORTS_AS_FIRST_ELEM	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) Imports допустим только в качестве первого элемента таблицы стилей!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_IMPORTING_ITSELF	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} непосредственно или косвенно импортирует себя!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XMLSPACE_ILLEGAL_VAL	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) Для xml:space указано недопустимое значение: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка processStylesheet!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SAX_EXCEPTION	TokenNameIdentifier
,	TokenNameCOMMA
"Исключительная ситуация SAX"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FUNCTION_NOT_SUPPORTED	TokenNameIdentifier
...
ER_XSLT_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка XSLT"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CURRENCY_SIGN_ILLEGAL	TokenNameIdentifier
,	TokenNameCOMMA
"Символ денежной единицы недопустим в строке форматирования шаблона"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM	TokenNameIdentifier
,	TokenNameCOMMA
"Функция документа не поддерживается в DOM таблицы стилей!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось преобразовать префикс преобразователя non-Prefix!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REDIRECT_COULDNT_GET_FILENAME	TokenNameIdentifier
,	TokenNameCOMMA
"Расширение перенаправления: Не удалось получить имя файла - атрибут file или select должен возвращать допустимую строку."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось создать FormatterListener в расширении перенаправления!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимый префикс в exclude-result-prefixes: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_NS_URI	TokenNameIdentifier
,	TokenNameCOMMA
"Для указанного префикса отсутствует URI пространства имен"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_ARG_FOR_OPTION	TokenNameIdentifier
,	TokenNameCOMMA
"Отсутствует аргумент опции: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_OPTION	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимая опция: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MALFORMED_FORMAT_STRING	TokenNameIdentifier
,	TokenNameCOMMA
"Неправильная строка форматирования: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"Для xsl:stylesheet необходим атрибут 'version'!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"Атрибут: В {0} указано недопустимое значение: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CHOOSE_REQUIRES_WHEN	TokenNameIdentifier
,	TokenNameCOMMA
"Для xsl:choose необходим xsl:when"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_APPLY_IMPORT_IN_FOR_EACH	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:apply-imports не допускается в xsl:for-each"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_USE_DTM_FOR_OUTPUT	TokenNameIdentifier
,	TokenNameCOMMA
"Нельзя применять DTMLiaison для узла вывода DOM ... Используйте org.apache.xpath.DOM2Helper!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_USE_DTM_FOR_INPUT	TokenNameIdentifier
,	TokenNameCOMMA
"Нельзя применять DTMLiaison для узла ввода DOM ... Используйте org.apache.xpath.DOM2Helper!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CALL_TO_EXT_FAILED	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка при вызове элемента расширения: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier
...
ER_XSLATTRSET_USED_ITSELF	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:attribute-set {0} применяет себя, что приведет к образованию бесконечного цикла."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_MIX_XERCESDOM	TokenNameIdentifier
,	TokenNameCOMMA
"Нельзя одновременно применять ввод не-Xerces-DOM и вывод Xerces-DOM!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TOO_MANY_LISTENERS	TokenNameIdentifier
...
ER_IN_ELEMTEMPLATEELEM_READOBJECT	TokenNameIdentifier
,	TokenNameCOMMA
"В ElemTemplateElement.readObject: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DUPLICATE_NAMED_TEMPLATE	TokenNameIdentifier
,	TokenNameCOMMA
"Обнаружено несколько шаблонов с заданным именем: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_KEY_CALL	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимый вызов функции: рекурсивные вызовы key() недопустимы"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REFERENCING_ITSELF	TokenNameIdentifier
,	TokenNameCOMMA
"Переменная {0} непосредственно или косвенно ссылается на себя!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_DOMSOURCE_INPUT	TokenNameIdentifier
,	TokenNameCOMMA
"Для DOMSource в newTemplates узел ввода не может быть пустым!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CLASS_NOT_FOUND_FOR_OPTION	TokenNameIdentifier
,	TokenNameCOMMA
"Не найден файл класса для опции {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REQUIRED_ELEM_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"Не найден обязательный элемент: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INPUT_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"InputStream не может быть пустым"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_URI_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"URI не может быть пустым"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FILE_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"Файл не может быть пустым"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SOURCE_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"InputSource не может быть пустым"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_INIT_BSFMGR	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось инициализировать администратор BSF"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_CMPL_EXTENSN	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось откомпилировать расширение"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_CREATE_EXTENSN	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось создать расширение: {0}, причина: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INSTANCE_MTHD_CALL_REQUIRES	TokenNameIdentifier
,	TokenNameCOMMA
"При вызове в экземпляре метода {0} в первом аргументе должен быть передан экземпляр объекта"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_ELEMENT_NAME	TokenNameIdentifier
,	TokenNameCOMMA
"Указано недопустимое имя элемента {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ELEMENT_NAME_METHOD_STATIC	TokenNameIdentifier
,	TokenNameCOMMA
"Метод name элемента должен быть статическим {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_EXTENSION_FUNC_UNKNOWN	TokenNameIdentifier
,	TokenNameCOMMA
"Неизвестная функция расширения {0} : {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MORE_MATCH_CONSTRUCTOR	TokenNameIdentifier
,	TokenNameCOMMA
"Несколько наилучших соответствий для конструктора {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MORE_MATCH_METHOD	TokenNameIdentifier
,	TokenNameCOMMA
"Несколько лучших соответствий для метода {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MORE_MATCH_ELEMENT	TokenNameIdentifier
,	TokenNameCOMMA
"Несколько лучших соответствий для метода элемента {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_CONTEXT_PASSED	TokenNameIdentifier
,	TokenNameCOMMA
"Для вычисления передан недопустимый контекст {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_POOL_EXISTS	TokenNameIdentifier
,	TokenNameCOMMA
"Пул уже существует"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_DRIVER_NAME	TokenNameIdentifier
,	TokenNameCOMMA
"Не указано имя драйвера"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_URL	TokenNameIdentifier
,	TokenNameCOMMA
"Не указан URL"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_POOL_SIZE_LESSTHAN_ONE	TokenNameIdentifier
,	TokenNameCOMMA
"Размер пула меньше единицы!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_DRIVER	TokenNameIdentifier
,	TokenNameCOMMA
"Указано недопустимое имя драйвера!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_STYLESHEETROOT	TokenNameIdentifier
,	TokenNameCOMMA
"Не найден корневой элемент таблицы стилей!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_XMLSPACE_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение xml:space"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSFROMNODE_FAILED	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка processFromNode"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_RESOURCE_COULD_NOT_LOAD	TokenNameIdentifier
...
ER_UNKNOWN_ERROR_CALLING_EXTENSION	TokenNameIdentifier
,	TokenNameCOMMA
"Неизвестная ошибка при вызове расширения"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_NAMESPACE_DECL	TokenNameIdentifier
,	TokenNameCOMMA
"У префикса {0} отсутствует объявление соответствующего пространства имен"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ELEM_CONTENT_NOT_ALLOWED	TokenNameIdentifier
,	TokenNameCOMMA
"Содержимое элемента недопустимо для lang=javaclass {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_STYLESHEET_DIRECTED_TERMINATION	TokenNameIdentifier
,	TokenNameCOMMA
"Прервано в соответствии с таблицей стилей"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ONE_OR_TWO	TokenNameIdentifier
,	TokenNameCOMMA
"1 или 2"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TWO_OR_THREE	TokenNameIdentifier
...
ER_COULD_NOT_LOAD_RESOURCE	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось загрузить {0} (проверьте настройку CLASSPATH), применяются значения по умолчанию"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_INIT_DEFAULT_TEMPLATES	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось инициализировать шаблоны по умолчанию"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_RESULT_NULL	TokenNameIdentifier
...
ER_RESULT_COULD_NOT_BE_SET	TokenNameIdentifier
,	TokenNameCOMMA
"Невозможно задать результат"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_OUTPUT_SPECIFIED	TokenNameIdentifier
,	TokenNameCOMMA
"Не указан вывод"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_TRANSFORM_TO_RESULT_TYPE	TokenNameIdentifier
,	TokenNameCOMMA
"Невозможно преобразовать в Результат типа {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_TRANSFORM_SOURCE_TYPE	TokenNameIdentifier
,	TokenNameCOMMA
"Невозможно преобразовать в Источник типа {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_CONTENT_HANDLER	TokenNameIdentifier
,	TokenNameCOMMA
"Пустой обработчик содержания"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_ERROR_HANDLER	TokenNameIdentifier
...
ER_CANNOT_CALL_PARSE	TokenNameIdentifier
,	TokenNameCOMMA
"Невозможно вызвать анализатор, если не задан ContentHandler"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_PARENT_FOR_FILTER	TokenNameIdentifier
,	TokenNameCOMMA
"Не задан родительский объект фильтра"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_STYLESHEET_IN_MEDIA	TokenNameIdentifier
,	TokenNameCOMMA
"В {0} не найдена таблица стилей, носитель={1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_STYLESHEET_PI	TokenNameIdentifier
,	TokenNameCOMMA
"Не найден PI xml-stylesheet в {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_SUPPORTED	TokenNameIdentifier
...
ER_PROPERTY_VALUE_BOOLEAN	TokenNameIdentifier
,	TokenNameCOMMA
"Значение свойства {0} должно быть экземпляром Boolean"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULD_NOT_FIND_EXTERN_SCRIPT	TokenNameIdentifier
,	TokenNameCOMMA
"Невозможно получить внешний сценарий в {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_RESOURCE_COULD_NOT_FIND	TokenNameIdentifier
...
ER_OUTPUT_PROPERTY_NOT_RECOGNIZED	TokenNameIdentifier
,	TokenNameCOMMA
"Свойство вывода не распознано: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FAILED_CREATING_ELEMLITRSLT	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось создать элемент ElemLiteralResult"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_VALUE_SHOULD_BE_NUMBER	TokenNameIdentifier
,	TokenNameCOMMA
"Значение {0} должно быть анализируемым числом"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_VALUE_SHOULD_EQUAL	TokenNameIdentifier
,	TokenNameCOMMA
"В {0} должно быть указано значение yes или no"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FAILED_CALLING_METHOD	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка при вызове метода {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FAILED_CREATING_ELEMTMPL	TokenNameIdentifier
,	TokenNameCOMMA
"Ошибка при создании экземпляра ElemTemplateElement"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CHARS_NOT_ALLOWED	TokenNameIdentifier
,	TokenNameCOMMA
"Символы недопустимы в данной позиции документа"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ATTR_NOT_ALLOWED	TokenNameIdentifier
,	TokenNameCOMMA
"Атрибут "{0}" недопустим в элементе {1}!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_BAD_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"{0} неверное значение {1} "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ATTRIB_VALUE_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"Не найдено значение атрибута {0} "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ATTRIB_VALUE_NOT_RECOGNIZED	TokenNameIdentifier
,	TokenNameCOMMA
"Значение атрибута {0} не распознано "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_URI_NAMESPACE	TokenNameIdentifier
,	TokenNameCOMMA
"Попытка создать префикс пространства имен с пустым URI"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NUMBER_TOO_BIG	TokenNameIdentifier
,	TokenNameCOMMA
"Попытка отформатировать число больше максимально допустимого LongInteger"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_FIND_SAX1_DRIVER	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось найти класс драйвера SAX1 {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SAX1_DRIVER_NOT_LOADED	TokenNameIdentifier
,	TokenNameCOMMA
"Класс драйвера SAX1 {0} обнаружен, но его загрузка невозможна"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SAX1_DRIVER_NOT_INSTANTIATED	TokenNameIdentifier
,	TokenNameCOMMA
"Класс драйвера SAX1 {0} загружен, но его инициализация невозможна"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER	TokenNameIdentifier
,	TokenNameCOMMA
"В классе драйвера SAX1 {0} не реализован org.xml.sax.Parser"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PARSER_PROPERTY_NOT_SPECIFIED	TokenNameIdentifier
,	TokenNameCOMMA
"Не задано системное свойство org.xml.sax.parser"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PARSER_ARG_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"Аргумент анализатора не должен быть пустым"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FEATURE	TokenNameIdentifier
,	TokenNameCOMMA
"Функция: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROPERTY	TokenNameIdentifier
,	TokenNameCOMMA
"Свойство: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_ENTITY_RESOLVER	TokenNameIdentifier
,	TokenNameCOMMA
"Пустой преобразователь макроса"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_DTD_HANDLER	TokenNameIdentifier
,	TokenNameCOMMA
"Пустой дескриптор DTD"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_DRIVER_NAME_SPECIFIED	TokenNameIdentifier
...
ER_POOLSIZE_LESS_THAN_ONE	TokenNameIdentifier
,	TokenNameCOMMA
"Размер пула меньше 1!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_DRIVER_NAME	TokenNameIdentifier
...
ER_ASSERT_NO_TEMPLATE_PARENT	TokenNameIdentifier
,	TokenNameCOMMA
"Программная ошибка! У выражения нет родительского элемента ElemTemplateElement!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR	TokenNameIdentifier
,	TokenNameCOMMA
"Запись программиста в RedundentExprEliminator: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier
,	TokenNameCOMMA
"{0} недопустимо в данной позиции таблицы стилей!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier
,	TokenNameCOMMA
"Текст недопустим в данной позиции таблицы стилей!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_TCHAR	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение {1} атрибута CHAR: {0}.  Атрибут типа CHAR должен содержать только 1 символ!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_QNAME	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение {1} атрибута QNAME: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_ENUM	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение {1} атрибута ENUM: {0}.  Допустимые значения: {2}."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_NMTOKEN	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение {1} атрибута NMTOKEN: {0}. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_NCNAME	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение {1} атрибута NCNAME: {0}. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_BOOLEAN	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение {1} атрибута boolean: {0}. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_NUMBER	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение {1} атрибута number: {0}. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ARG_LITERAL	TokenNameIdentifier
,	TokenNameCOMMA
"Аргумент {0} в шаблоне сравнения должен быть литералом."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DUPLICATE_GLOBAL_VAR	TokenNameIdentifier
,	TokenNameCOMMA
"Повторное объявление глобальной переменной."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DUPLICATE_VAR	TokenNameIdentifier
,	TokenNameCOMMA
"Повторное объявление переменной."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TEMPLATE_NAME_MATCH	TokenNameIdentifier
,	TokenNameCOMMA
"Для xsl:template должен быть задан атрибут name или match, либо оба этих атрибута"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_PREFIX	TokenNameIdentifier
...
ER_NO_ATTRIB_SET	TokenNameIdentifier
,	TokenNameCOMMA
"attribute-set с именем {0} не существует"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FUNCTION_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"Функция с именем {0} не существует"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_HAVE_CONTENT_AND_SELECT	TokenNameIdentifier
,	TokenNameCOMMA
"Для элемента {0} нельзя одновременно указывать атрибуты содержания и выбора. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_SET_PARAM_VALUE	TokenNameIdentifier
...
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT	TokenNameIdentifier
,	TokenNameCOMMA
"Атрибут result-prefix элемента xsl:namespace-alias содержит значение '#default', но объявление пространства имен по умолчанию в области для данного элемента не найдено"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"Атрибут result-prefix элемента xsl:namespace-alias содержит значение ''{0}'', но объявление пространства имен для префикса ''{0}'' в области данного элемента не найдено. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SET_FEATURE_NULL_NAME	TokenNameIdentifier
...
ER_NAMESPACE_CONTEXT_NULL_NAMESPACE	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось найти префикс для uri пустого пространства имен. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NAMESPACE_CONTEXT_NULL_PREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось найти uri пространства имен для пустого префикса. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XPATH_RESOLVER_NULL_QNAME	TokenNameIdentifier
,	TokenNameCOMMA
"Имя функции не может быть пустым. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XPATH_RESOLVER_NEGATIVE_ARITY	TokenNameIdentifier
,	TokenNameCOMMA
"Число аргументов не может быть отрицательным. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_FOUND_CURLYBRACE	TokenNameIdentifier
,	TokenNameCOMMA
"Найдена закрывающая скобка '}', но открытые шаблоны атрибутов отсутствуют!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR	TokenNameIdentifier
,	TokenNameCOMMA
"Предупреждение: Атрибут count не соответствует родительскому в xsl:number! Целевой = {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_EXPR_ATTRIB_CHANGED_TO_SELECT	TokenNameIdentifier
,	TokenNameCOMMA
"Старый синтаксис: Имя атрибута 'expr' изменено на 'select'."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_NO_LOCALE_IN_FORMATNUMBER	TokenNameIdentifier
,	TokenNameCOMMA
"Xalan еще не может обрабатывать имя локали в функции format-number."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_LOCALE_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"Предупреждение: Не найдена локаль для xml:lang={0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_CANNOT_MAKE_URL_FROM	TokenNameIdentifier
...
WG_CANNOT_LOAD_REQUESTED_DOC	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось загрузить запрошенный документ: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_CANNOT_FIND_COLLATOR	TokenNameIdentifier
,	TokenNameCOMMA
"Не удалось найти Collator для <sort xml:lang={0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_FUNCTIONS_SHOULD_USE_URL	TokenNameIdentifier
,	TokenNameCOMMA
"Старый синтаксис: в инструкции functions не следует применять url {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ENCODING_NOT_SUPPORTED_USING_UTF8	TokenNameIdentifier
,	TokenNameCOMMA
"Кодировка не поддерживается: {0}, применяется UTF-8"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ENCODING_NOT_SUPPORTED_USING_JAVA	TokenNameIdentifier
,	TokenNameCOMMA
"Кодировка не поддерживается: {0}, применяется Java {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_SPECIFICITY_CONFLICTS	TokenNameIdentifier
,	TokenNameCOMMA
"Обнаружен конфликт спецификаций: Будет применяться последний обнаруженный в таблице стилей {0}."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_PARSING_AND_PREPARING	TokenNameIdentifier
,	TokenNameCOMMA
"========= Анализ и подготовка {0} =========="	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ATTR_TEMPLATE	TokenNameIdentifier
,	TokenNameCOMMA
"Шаблон атрибута, {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE	TokenNameIdentifier
,	TokenNameCOMMA
"Конфликт соответствия xsl:strip-space и xsl:preserve-space"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ATTRIB_NOT_HANDLED	TokenNameIdentifier
,	TokenNameCOMMA
"Xalan еще не может обрабатывать атрибут {0}!"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_NO_DECIMALFORMAT_DECLARATION	TokenNameIdentifier
,	TokenNameCOMMA
"Не найдено объявление десятичного формата: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_OLD_XSLT_NS	TokenNameIdentifier
,	TokenNameCOMMA
"Отсутствующее или неверное пространство имен XSLT. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED	TokenNameIdentifier
,	TokenNameCOMMA
"Допустимо только одно объявление xsl:decimal-format по умолчанию."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE	TokenNameIdentifier
,	TokenNameCOMMA
"Имена xsl:decimal-format должны быть уникальными. Имя "{0}" повторяется."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ILLEGAL_ATTRIBUTE	TokenNameIdentifier
...
WG_COULD_NOT_RESOLVE_PREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"Невозможно преобразовать префикс пространства имен: {0}. Узел будет проигнорирован."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier
...
WG_ILLEGAL_ATTRIBUTE_NAME	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое имя атрибута: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"Недопустимое значение атрибута {0}: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_EMPTY_SECOND_ARG	TokenNameIdentifier
,	TokenNameCOMMA
"Результирующий набор узлов из второго аргумента функции document пуст. Возврат пустого node-set."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier
,	TokenNameCOMMA
"Значение атрибута 'name' в имени xsl:processing-instruction не должно быть равно 'xml'"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier
,	TokenNameCOMMA
"Значение атрибута ''name'' в xsl:processing-instruction должно быть допустимым именем NCName: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ILLEGAL_ATTRIBUTE_POSITION	TokenNameIdentifier
,	TokenNameCOMMA
"Невозможно добавить атрибут {0} после дочерних узлов или перед созданием элемента.  Атрибут будет проигнорирован. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
NO_MODIFICATION_ALLOWED_ERR	TokenNameIdentifier
,	TokenNameCOMMA
"Попытка изменения объекта, изменение которого запрещено. "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"Опции процесса командной строки Xalan-J:"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_option"	TokenNameStringLiteral
...
,	TokenNameCOMMA
"Опция {0} не поддерживается в режиме XSLTC."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_invalid_xalan_option"	TokenNameStringLiteral
,	TokenNameCOMMA
"Опция {0} может применяться только с -XSLTC."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_no_input"	TokenNameStringLiteral
,	TokenNameCOMMA
"Ошибка: Не указана таблица стилей или исходный файл xml. Для просмотра справки по использованию команды введите команду без параметров."	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_common_options"	TokenNameStringLiteral
,	TokenNameCOMMA
"-Общие опции-"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_xalan_options"	TokenNameStringLiteral
,	TokenNameCOMMA
"-Опции Xalan-"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_xsltc_options"	TokenNameStringLiteral
,	TokenNameCOMMA
"-Опции XSLTC-"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_return_to_continue"	TokenNameStringLiteral
,	TokenNameCOMMA
"(Для продолжения нажмите <Enter>)"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXSLTC"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XSLTC (для преобразования используйте XSLTC)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"   [-PARSER полное имя класса анализатора]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionE"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-E (Не разворачивать ссылки на макросы entity)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"   [-QC (Не показывать предупреждения о конфликтах шаблонов)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionQ"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-Q  (Тихий режим)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionLF"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-LF (Применять в выводе только LF {по умолчанию - CR/LF})]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionCR"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-CR (Применять в выводе только CR {по умолчанию - CR/LF})]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionESCAPE"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-ESCAPE (Символы, требующие Esc-последовательностей {по умолчанию - <>&"'\r\n}]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionINDENT"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-INDENT (Число пробелов в отступе {по умолчанию - 0})]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTT"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TT (Трассировка вызываемых шаблонов.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTG"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TG (Трассировка событий создания.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTS"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TS (Трассировка событий выбора.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTTC"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TTC (Трассировка обрабатываемых дочерних объектов шаблонов.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTCLASS"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TCLASS (Класс TraceListener для трассировка расширений.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionVALIDATE"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-VALIDATE (Включает проверку.  По умолчанию проверка выключена.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionEDUMP"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-EDUMP {необязательное имя файла} (Дамп стека при ошибке.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXML"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XML (Применять форматирование XML и добавлять заголовок XML.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTEXT"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TEXT (Применять текстовое форматирование.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionHTML"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-HTML (Применять форматирование HTML.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionPARAM"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-PARAM имя выражение (Задать параметр таблицы стилей)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"   [-URIRESOLVER имя класса (URIResolver для преобразования URL)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionENTITYRESOLVER"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-ENTITYRESOLVER имя класса (EntityResolver для преобразования макросов)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionCONTENTHANDLER"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-CONTENTHANDLER имя класса (ContentHandler для сериализации вывода)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionLINENUMBERS"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-L применять номера строк исходного документа]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionSECUREPROCESSING"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-SECURE (задайте для функции защищенной обработки значение true.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionMEDIA"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-MEDIA тип-носит. (Применять атрибут носителя для поиска таблицы стилей.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionFLAVOR"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-FLAVOR имя-преобразования (Явно указать s2s=SAX или d2d=DOM.)] "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionDIAG"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-DIAG (Печать отчета о времени преобразования в миллисекундах.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionINCREMENTAL"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-INCREMENTAL (Запросить дополняющую модель DTM с помощью значения http://xml.apache.org/xalan/features/incremental true.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionNOOPTIMIMIZE"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-NOOPTIMIMIZE (Отключить оптимизацию таблицы стилей с помощью значения http://xml.apache.org/xalan/features/optimize false.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionRL"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-RL ограничение (Числовое ограничение глубины рекурсии таблиц стилей.)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXO"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XO [имя-процедуры] (Присвоить имя созданной процедуре преобразования)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXD"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XD целевой-каталог (Задает целевой каталог для процедуры преобразования)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXJ"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XJ файл-jar (Упаковывает классы процедуры преобразования в <файл-jar>)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXP"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XP пакет (Префикс имени пакета для всех созданных классов translet)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXN"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XN (разрешает копирование шаблона)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXX"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XX (включает вывод дополнительных отладочных сообщений)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXT"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XT (по возможности применяет процедуру преобразования)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"diagTiming"	TokenNameStringLiteral
,	TokenNameCOMMA
" --------- Преобразование {0} с помощью {1} заняло {2} мс"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"recursionTooDeep"	TokenNameStringLiteral
,	TokenNameCOMMA
"Слишком большая вложенность шаблонов. Вложенность = {0}, шаблон {1} {2}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"nameIs"	TokenNameStringLiteral
,	TokenNameCOMMA
"имя"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"matchPatternIs"	TokenNameStringLiteral
,	TokenNameCOMMA
"шаблон соответствия"	TokenNameStringLiteral
}	TokenNameRBRACE
}	TokenNameRBRACE
;	TokenNameSEMICOLON
}	TokenNameRBRACE
