...
XSLTErrorResources_ja	TokenNameIdentifier
...
ER_NO_CURLYBRACE	TokenNameIdentifier
,	TokenNameCOMMA
"エラー: 式内では '{' を使用できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_ATTRIBUTE	TokenNameIdentifier
,	TokenNameCOMMA
"{0} に正しくない属性があります: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_SOURCENODE_APPLYIMPORTS	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:apply-imports 内の sourceNode がヌルです。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_ADD	TokenNameIdentifier
,	TokenNameCOMMA
"{0} を {1} に追加できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES	TokenNameIdentifier
,	TokenNameCOMMA
"handleApplyTemplatesInstruction 内の sourceNode がヌルです。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"{0} には name 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TEMPLATE_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"{0} という名前のテンプレートが見つかりませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_RESOLVE_NAME_AVT	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:call-template 内の名前 AVT を解決できませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REQUIRES_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"{0} には属性が必要です: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MUST_HAVE_TEST_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"{0} には ''test'' 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_BAD_VAL_ON_LEVEL_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"level 属性で値が間違っています: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier
,	TokenNameCOMMA
"処理命令の名前は 'xml' にはできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier
,	TokenNameCOMMA
"処理命令の名前は有効な NCName でなければなりません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_MATCH_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"{0} にモードがある場合は、match 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_NAME_OR_MATCH_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"{0} には name または match のいずれかの属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_RESOLVE_NSPREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"名前空間接頭部を解決できません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"xml:space には正しくない値があります: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_OWNERDOC	TokenNameIdentifier
,	TokenNameCOMMA
"下位ノードに所有者文書がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ELEMTEMPLATEELEM_ERR	TokenNameIdentifier
,	TokenNameCOMMA
"ElemTemplateElement エラー: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_CHILD	TokenNameIdentifier
,	TokenNameCOMMA
"ヌルの子を追加しようとしています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_SELECT_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"{0} には select 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_TEST_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:when には 'test' 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NEED_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:with-param には 'name' 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_CONTEXT_OWNERDOC	TokenNameIdentifier
,	TokenNameCOMMA
"コンテキストに所有者文書がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULD_NOT_CREATE_XML_PROC_LIAISON	TokenNameIdentifier
,	TokenNameCOMMA
"XML TransformerFactory Liaison を作成できませんでした: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESS_NOT_SUCCESSFUL	TokenNameIdentifier
,	TokenNameCOMMA
"Xalan: 処理は成功しませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_SUCCESSFUL	TokenNameIdentifier
,	TokenNameCOMMA
"Xalan: は成功しませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ENCODING_NOT_SUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"エンコードはサポートされていません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULD_NOT_CREATE_TRACELISTENER	TokenNameIdentifier
,	TokenNameCOMMA
"TraceListener を作成できませんでした: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_KEY_REQUIRES_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:key には 'name' 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_KEY_REQUIRES_MATCH_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:key には 'match' 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_KEY_REQUIRES_USE_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:key には 'use' 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REQUIRES_ELEMENTS_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} には ''elements'' 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_PREFIX_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} に属性 ''prefix'' がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_BAD_STYLESHEET_URL	TokenNameIdentifier
,	TokenNameCOMMA
"スタイルシート URL が間違っています: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FILE_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"スタイルシート・ファイルが見つかりませんでした: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_IOEXCEPTION	TokenNameIdentifier
,	TokenNameCOMMA
"スタイルシート・ファイルによる入出力例外が起こりました: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_HREF_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} の href 属性が見つかりませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_STYLESHEET_INCLUDES_ITSELF	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} が自分自身を直接的または間接的に組み込もうとしています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSINCLUDE_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"StylesheetHandler.processInclude エラー、{0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_LANG_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} に属性 ''lang'' がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_CONTAINER_ELEMENT_COMPONENT	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} 要素の場所を間違えた可能性があります。コンテナー要素 ''component'' がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CAN_ONLY_OUTPUT_TO_ELEMENT	TokenNameIdentifier
,	TokenNameCOMMA
"Element、DocumentFragment、Document、または PrintWriter への出力しかできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESS_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"StylesheetRoot.処理エラー"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_UNIMPLNODE_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"UnImplNode エラー: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_SELECT_EXPRESSION	TokenNameIdentifier
,	TokenNameCOMMA
"エラー:  xpath select 式 (-select) が見つかりませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_SERIALIZE_XSLPROCESSOR	TokenNameIdentifier
,	TokenNameCOMMA
"XSLProcessor をシリアライズできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_INPUT_STYLESHEET	TokenNameIdentifier
,	TokenNameCOMMA
"スタイルシート入力が指定されていませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FAILED_PROCESS_STYLESHEET	TokenNameIdentifier
,	TokenNameCOMMA
"スタイルシートを処理することに失敗しました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULDNT_PARSE_DOC	TokenNameIdentifier
,	TokenNameCOMMA
"{0} 文書を構文解析できませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULDNT_FIND_FRAGMENT	TokenNameIdentifier
,	TokenNameCOMMA
"フラグメントが見つかりませんでした: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NODE_NOT_ELEMENT	TokenNameIdentifier
,	TokenNameCOMMA
"フラグメント ID により指されているノードが要素でありませんでした: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"for-each には match または name のいずれかの属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"テンプレートには match または name のいずれかの属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_CLONE_OF_DOCUMENT_FRAG	TokenNameIdentifier
,	TokenNameCOMMA
"文書フラグメントの複製がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_CREATE_ITEM	TokenNameIdentifier
,	TokenNameCOMMA
"項目を結果ツリーに作成できません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XMLSPACE_ILLEGAL_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"ソース XML 内の xml:space には正しくない値があります: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_XSLKEY_DECLARATION	TokenNameIdentifier
,	TokenNameCOMMA
"{0} の xsl:key 宣言がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_CREATE_URL	TokenNameIdentifier
,	TokenNameCOMMA
"エラー:  {0} の URL を作成できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XSLFUNCTIONS_UNSUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:functions はサポートされていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSOR_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"XSLT TransformerFactory エラー"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_ALLOWED_INSIDE_STYLESHEET	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} はスタイルシートの内部では許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_RESULTNS_NOT_SUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"result-ns はもうサポートされていません。  代りに xsl:output を使用してください。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DEFAULTSPACE_NOT_SUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"default-space はもうサポートされていません。  代りに xsl:strip-space または xsl:preserve-space を使用してください。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INDENTRESULT_NOT_SUPPORTED	TokenNameIdentifier
,	TokenNameCOMMA
"indent-result はもうサポートされていません。  代りに xsl:output を使用してください。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} には正しくない属性があります: {1}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_UNKNOWN_XSL_ELEM	TokenNameIdentifier
,	TokenNameCOMMA
"不明の XSL 要素: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_BAD_XSLSORT_USE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xsl:sort は xsl:apply-templates または xsl:for-each としか使用できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISPLACED_XSLWHEN	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xsl:when の場所を誤っていました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xsl:when が xsl:choose により親になっていませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISPLACED_XSLOTHERWISE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xsl:otherwise の場所を誤っていました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xsl:otherwise が xsl:choose により親になっていませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_ALLOWED_INSIDE_TEMPLATE	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} はテンプレートの内部では許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_UNKNOWN_EXT_NS_PREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} 拡張名前空間接頭部 {1} が不明です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_IMPORTS_AS_FIRST_ELEM	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) インポートは、スタイルシート内の先頭要素としてのみ入れることができます。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_IMPORTING_ITSELF	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) {0} が自分自身を直接的または間接的にインポートしようとしています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XMLSPACE_ILLEGAL_VAL	TokenNameIdentifier
,	TokenNameCOMMA
"(StylesheetHandler) xml:space に正しくない値があります: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL	TokenNameIdentifier
,	TokenNameCOMMA
"processStylesheet は成功していません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SAX_EXCEPTION	TokenNameIdentifier
,	TokenNameCOMMA
"SAX 例外"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FUNCTION_NOT_SUPPORTED	TokenNameIdentifier
...
ER_XSLT_ERROR	TokenNameIdentifier
,	TokenNameCOMMA
"XSLT エラー"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CURRENCY_SIGN_ILLEGAL	TokenNameIdentifier
,	TokenNameCOMMA
"通貨記号は書式パターン・ストリング内で許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM	TokenNameIdentifier
,	TokenNameCOMMA
"文書機能はスタイルシート DOM ではサポートされていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER	TokenNameIdentifier
,	TokenNameCOMMA
"非接頭部リゾルバーの接頭部を解決できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REDIRECT_COULDNT_GET_FILENAME	TokenNameIdentifier
,	TokenNameCOMMA
"リダイレクト拡張: ファイル名を取得できませんでした。file または select 属性は有効なストリングを戻さなければなりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT	TokenNameIdentifier
,	TokenNameCOMMA
"FormatterListener はリダイレクト拡張内にビルドできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"exclude-result-prefixes 内の接頭部が無効です: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_NS_URI	TokenNameIdentifier
,	TokenNameCOMMA
"指定された接頭部の名前空間 URI がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MISSING_ARG_FOR_OPTION	TokenNameIdentifier
,	TokenNameCOMMA
"オプションの引数がありません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_OPTION	TokenNameIdentifier
,	TokenNameCOMMA
"無効なオプション: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MALFORMED_FORMAT_STRING	TokenNameIdentifier
,	TokenNameCOMMA
"誤った形式の書式ストリング: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:stylesheet には 'version' 属性が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"属性: {0} には正しくない値: {1} があります。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CHOOSE_REQUIRES_WHEN	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:choose には xsl:when が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_APPLY_IMPORT_IN_FOR_EACH	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:apply-imports は xsl:for-each 内では許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_USE_DTM_FOR_OUTPUT	TokenNameIdentifier
,	TokenNameCOMMA
"DTMLiaison は出力 DOM ノードに使用できません... 代りに org.apache.xpath.DOM2Helper を渡してください。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_USE_DTM_FOR_INPUT	TokenNameIdentifier
,	TokenNameCOMMA
"DTMLiaison は入力 DOM ノードに使用できません... 代りに org.apache.xpath.DOM2Helper を渡してください。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CALL_TO_EXT_FAILED	TokenNameIdentifier
,	TokenNameCOMMA
"拡張要素への呼び出しが失敗しました: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier
...
ER_XSLATTRSET_USED_ITSELF	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:attribute-set {0} が自身を使用しているため、無限ループの原因となります。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_MIX_XERCESDOM	TokenNameIdentifier
,	TokenNameCOMMA
"非 Xerces-DOM 入力と Xerces-DOM 出力は混用できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TOO_MANY_LISTENERS	TokenNameIdentifier
...
ER_IN_ELEMTEMPLATEELEM_READOBJECT	TokenNameIdentifier
,	TokenNameCOMMA
"ElemTemplateElement.readObject 内: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DUPLICATE_NAMED_TEMPLATE	TokenNameIdentifier
,	TokenNameCOMMA
"次の名前のテンプレートが複数見つかりました: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_KEY_CALL	TokenNameIdentifier
,	TokenNameCOMMA
"無効な関数呼び出し: 再帰的 key() 呼び出しは許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REFERENCING_ITSELF	TokenNameIdentifier
,	TokenNameCOMMA
"変数 {0} が直接的または間接的に自分自身に参照づけています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_DOMSOURCE_INPUT	TokenNameIdentifier
,	TokenNameCOMMA
"newTemplates の DOMSource の入力ノードをヌルにはできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CLASS_NOT_FOUND_FOR_OPTION	TokenNameIdentifier
,	TokenNameCOMMA
"オプション {0} のクラス・ファイルが見つかりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_REQUIRED_ELEM_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"必要な要素が見つかりません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INPUT_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"InputStream をヌルにはできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_URI_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"URI をヌルにはできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FILE_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"ファイルをヌルにはできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SOURCE_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"InputSource をヌルにはできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_INIT_BSFMGR	TokenNameIdentifier
,	TokenNameCOMMA
"BSF マネージャーを初期化できませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_CMPL_EXTENSN	TokenNameIdentifier
,	TokenNameCOMMA
"拡張機能をコンパイルできませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_CREATE_EXTENSN	TokenNameIdentifier
,	TokenNameCOMMA
"原因: {1} のために拡張機能: {0} を作成できませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INSTANCE_MTHD_CALL_REQUIRES	TokenNameIdentifier
,	TokenNameCOMMA
"メソッド {0} へのインスタンス・メソッド呼び出しにはオブジェクト・インスタンスが最初の引数として必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_ELEMENT_NAME	TokenNameIdentifier
,	TokenNameCOMMA
"無効な要素名が指定されました: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ELEMENT_NAME_METHOD_STATIC	TokenNameIdentifier
,	TokenNameCOMMA
"要素名メソッドは静的でなければなりません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_EXTENSION_FUNC_UNKNOWN	TokenNameIdentifier
,	TokenNameCOMMA
"拡張機能 {0} : {1} が不明です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MORE_MATCH_CONSTRUCTOR	TokenNameIdentifier
,	TokenNameCOMMA
"{0} のコンストラクターの最適一致が複数あります。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MORE_MATCH_METHOD	TokenNameIdentifier
,	TokenNameCOMMA
"メソッド {0} の最適一致が複数あります。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_MORE_MATCH_ELEMENT	TokenNameIdentifier
,	TokenNameCOMMA
"要素メソッド {0} の最適一致が複数あります。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_CONTEXT_PASSED	TokenNameIdentifier
,	TokenNameCOMMA
"{0} を評価するために渡されたコンテキストが無効です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_POOL_EXISTS	TokenNameIdentifier
,	TokenNameCOMMA
"プールはすでに存在しています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_DRIVER_NAME	TokenNameIdentifier
,	TokenNameCOMMA
"ドライバー名が指定されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_URL	TokenNameIdentifier
,	TokenNameCOMMA
"URL が指定されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_POOL_SIZE_LESSTHAN_ONE	TokenNameIdentifier
,	TokenNameCOMMA
"プール・サイズが 1 より小です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_DRIVER	TokenNameIdentifier
,	TokenNameCOMMA
"無効なドライバー名が指定されました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_STYLESHEETROOT	TokenNameIdentifier
,	TokenNameCOMMA
"スタイルシートのルートが見つかりませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ILLEGAL_XMLSPACE_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"xml:space の値が正しくありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROCESSFROMNODE_FAILED	TokenNameIdentifier
,	TokenNameCOMMA
"processFromNode が失敗しました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_RESOURCE_COULD_NOT_LOAD	TokenNameIdentifier
...
ER_UNKNOWN_ERROR_CALLING_EXTENSION	TokenNameIdentifier
,	TokenNameCOMMA
"エクステンションを呼び出し時に不明エラー"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_NAMESPACE_DECL	TokenNameIdentifier
,	TokenNameCOMMA
"接頭部 {0} には対応している名前空間宣言がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ELEM_CONTENT_NOT_ALLOWED	TokenNameIdentifier
,	TokenNameCOMMA
"要素の内容は lang=javaclass {0} の場合は許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_STYLESHEET_DIRECTED_TERMINATION	TokenNameIdentifier
,	TokenNameCOMMA
"スタイルシートで終了が指図されました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ONE_OR_TWO	TokenNameIdentifier
,	TokenNameCOMMA
"1 または 2"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TWO_OR_THREE	TokenNameIdentifier
,	TokenNameCOMMA
"2 または 3"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULD_NOT_LOAD_RESOURCE	TokenNameIdentifier
,	TokenNameCOMMA
"{0} をロードできませんでした (CLASSPATH を調べてください)。現在はまさにデフォルトを使用中です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_INIT_DEFAULT_TEMPLATES	TokenNameIdentifier
,	TokenNameCOMMA
"デフォルト・テンプレートを初期化できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_RESULT_NULL	TokenNameIdentifier
...
ER_RESULT_COULD_NOT_BE_SET	TokenNameIdentifier
,	TokenNameCOMMA
"結果を設定できませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_OUTPUT_SPECIFIED	TokenNameIdentifier
,	TokenNameCOMMA
"出力が指定されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_TRANSFORM_TO_RESULT_TYPE	TokenNameIdentifier
,	TokenNameCOMMA
"型 {0} の Result に変換できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_TRANSFORM_SOURCE_TYPE	TokenNameIdentifier
,	TokenNameCOMMA
"型 {0} の Source を変換できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_CONTENT_HANDLER	TokenNameIdentifier
,	TokenNameCOMMA
"ヌルのコンテンツ・ハンドラー"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_ERROR_HANDLER	TokenNameIdentifier
,	TokenNameCOMMA
"ヌルのエラー・ハンドラー"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_CALL_PARSE	TokenNameIdentifier
,	TokenNameCOMMA
"ContentHandler が未設定の場合は parse の呼び出しはできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_PARENT_FOR_FILTER	TokenNameIdentifier
,	TokenNameCOMMA
"フィルターの親がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_STYLESHEET_IN_MEDIA	TokenNameIdentifier
,	TokenNameCOMMA
"スタイルシートが {0}、メディア= {1} に見つかりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_STYLESHEET_PI	TokenNameIdentifier
,	TokenNameCOMMA
"XML スタイルシート PI が {0} に見つかりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_SUPPORTED	TokenNameIdentifier
...
ER_PROPERTY_VALUE_BOOLEAN	TokenNameIdentifier
,	TokenNameCOMMA
"プロパティー {0} の値はブール・インスタンスにする必要があります。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_COULD_NOT_FIND_EXTERN_SCRIPT	TokenNameIdentifier
,	TokenNameCOMMA
"{0} の外部スクリプトへ到達できませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_RESOURCE_COULD_NOT_FIND	TokenNameIdentifier
...
ER_OUTPUT_PROPERTY_NOT_RECOGNIZED	TokenNameIdentifier
,	TokenNameCOMMA
"出力プロパティーは認識されていません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FAILED_CREATING_ELEMLITRSLT	TokenNameIdentifier
,	TokenNameCOMMA
"ElemLiteralResult インスタンスの作成が失敗しました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_VALUE_SHOULD_BE_NUMBER	TokenNameIdentifier
,	TokenNameCOMMA
"{0} の値には構文解析可能番号が含まれているはずです。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_VALUE_SHOULD_EQUAL	TokenNameIdentifier
,	TokenNameCOMMA
"{0} の値は yes または no と等しくなければなりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FAILED_CALLING_METHOD	TokenNameIdentifier
,	TokenNameCOMMA
"{0} メソッドの呼び出しが失敗しました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FAILED_CREATING_ELEMTMPL	TokenNameIdentifier
,	TokenNameCOMMA
"ElemTemplateElement インスタンスの作成が失敗しました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CHARS_NOT_ALLOWED	TokenNameIdentifier
,	TokenNameCOMMA
"文字は文書内のこのポイントでは許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ATTR_NOT_ALLOWED	TokenNameIdentifier
,	TokenNameCOMMA
""{0}" 属性は {1} 要素では許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_BAD_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"{0} の間違った値 {1} "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ATTRIB_VALUE_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"{0} 属性値が見つかりません。 "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ATTRIB_VALUE_NOT_RECOGNIZED	TokenNameIdentifier
,	TokenNameCOMMA
"{0} 属性値は認識されません。 "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_URI_NAMESPACE	TokenNameIdentifier
,	TokenNameCOMMA
"名前空間接頭部をヌルの URI で生成しようとしています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NUMBER_TOO_BIG	TokenNameIdentifier
,	TokenNameCOMMA
"最大 Long 整数より大きい数をフォーマットしようとしています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANNOT_FIND_SAX1_DRIVER	TokenNameIdentifier
,	TokenNameCOMMA
"SAX1 ドライバー・クラス {0} が見つかりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SAX1_DRIVER_NOT_LOADED	TokenNameIdentifier
,	TokenNameCOMMA
"SAX1 ドライバー・クラス {0} が見つかりましたがロードできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SAX1_DRIVER_NOT_INSTANTIATED	TokenNameIdentifier
,	TokenNameCOMMA
"SAX1 ドライバー・クラス {0} がロードされましたがインスタンス生成できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER	TokenNameIdentifier
,	TokenNameCOMMA
"SAX1 ドライバー・クラス {0} が org.xml.sax.Parser を実装していません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PARSER_PROPERTY_NOT_SPECIFIED	TokenNameIdentifier
,	TokenNameCOMMA
"システム・プロパティー org.xml.sax.parser は指定されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PARSER_ARG_CANNOT_BE_NULL	TokenNameIdentifier
,	TokenNameCOMMA
"パーサーの引数をヌルにしてはなりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FEATURE	TokenNameIdentifier
,	TokenNameCOMMA
"機能: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_PROPERTY	TokenNameIdentifier
,	TokenNameCOMMA
"プロパティー: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_ENTITY_RESOLVER	TokenNameIdentifier
,	TokenNameCOMMA
"ヌル実体リゾルバー"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NULL_DTD_HANDLER	TokenNameIdentifier
,	TokenNameCOMMA
"ヌル DTD ハンドラー"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NO_DRIVER_NAME_SPECIFIED	TokenNameIdentifier
...
ER_POOLSIZE_LESS_THAN_ONE	TokenNameIdentifier
,	TokenNameCOMMA
"プール・サイズが 1 より小さくなっています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_DRIVER_NAME	TokenNameIdentifier
...
ER_ASSERT_NO_TEMPLATE_PARENT	TokenNameIdentifier
,	TokenNameCOMMA
"プログラマーのエラー:  式に ElemTemplateElement 親がありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR	TokenNameIdentifier
,	TokenNameCOMMA
"RedundentExprEliminator 内のプログラマーのアサーション: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier
,	TokenNameCOMMA
"{0} はスタイルシートのこの位置では許可されません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier
,	TokenNameCOMMA
"空白文字以外のテキストはスタイルシートのこの位置では許可されません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_TCHAR	TokenNameIdentifier
,	TokenNameCOMMA
"正しくない値: {1} が CHAR 属性: {0} に使用されました。CHAR 型の属性は 1 文字でなければなりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_QNAME	TokenNameIdentifier
,	TokenNameCOMMA
"正しくない値: {1} が QNAME 属性: {0} に使用されました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_ENUM	TokenNameIdentifier
,	TokenNameCOMMA
"正しくない値: {1} が ENUM 属性: {0} に使用されました。有効値: {2}。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_NMTOKEN	TokenNameIdentifier
,	TokenNameCOMMA
"正しくない値: {1} が NMTOKEN 属性: {0} に使用されました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_NCNAME	TokenNameIdentifier
,	TokenNameCOMMA
"正しくない値: {1} が NCNAME 属性: {0} に使用されました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_BOOLEAN	TokenNameIdentifier
,	TokenNameCOMMA
"正しくない値: {1} が boolean 属性: {0} に使用されました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
INVALID_NUMBER	TokenNameIdentifier
,	TokenNameCOMMA
"正しくない値: {1} が number 属性: {0} に使用されました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_ARG_LITERAL	TokenNameIdentifier
,	TokenNameCOMMA
"マッチング・パターンの {0} への引数はリテラルでなければなりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DUPLICATE_GLOBAL_VAR	TokenNameIdentifier
,	TokenNameCOMMA
"グローバル変数宣言が重複しています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_DUPLICATE_VAR	TokenNameIdentifier
,	TokenNameCOMMA
"変数宣言が重複しています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_TEMPLATE_NAME_MATCH	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:template には name または match 属性 (あるいはその両方) が必要です。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_PREFIX	TokenNameIdentifier
...
ER_NO_ATTRIB_SET	TokenNameIdentifier
,	TokenNameCOMMA
"{0} という名前の attribute-set が存在していません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_FUNCTION_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"{0} という名前の関数が存在していません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_CANT_HAVE_CONTENT_AND_SELECT	TokenNameIdentifier
,	TokenNameCOMMA
"{0} 要素に内容および select 属性の両方があってはなりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_SET_PARAM_VALUE	TokenNameIdentifier
...
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:namespace-alias 要素の result-prefix 属性の値が '#default' になっていますが、この要素のスコープ内にはデフォルト名前空間の宣言はありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:namespace-alias 要素の result-prefix 属性の値が ''{0}'' になっていますが、この要素のスコープ内には接頭部 ''{0}'' の名前空間宣言はありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_SET_FEATURE_NULL_NAME	TokenNameIdentifier
...
ER_NAMESPACE_CONTEXT_NULL_NAMESPACE	TokenNameIdentifier
,	TokenNameCOMMA
"ヌル名前空間 URI の接頭部は取得できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_NAMESPACE_CONTEXT_NULL_PREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"ヌル接頭部の名前空間 URI は取得できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XPATH_RESOLVER_NULL_QNAME	TokenNameIdentifier
,	TokenNameCOMMA
"関数名 はヌルにできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
ER_XPATH_RESOLVER_NEGATIVE_ARITY	TokenNameIdentifier
,	TokenNameCOMMA
"アリティー (引数の数) は負の値にできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_FOUND_CURLYBRACE	TokenNameIdentifier
,	TokenNameCOMMA
"'}' が見つかりましたが、オープンされた属性テンプレートがありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR	TokenNameIdentifier
,	TokenNameCOMMA
"警告: count 属性が xsl:number 内の上位と一致しません。 ターゲット = {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_EXPR_ATTRIB_CHANGED_TO_SELECT	TokenNameIdentifier
,	TokenNameCOMMA
"旧構文: 'expr' 属性の名前が 'select' に変更されています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_NO_LOCALE_IN_FORMATNUMBER	TokenNameIdentifier
,	TokenNameCOMMA
"Xalan はフォーマット番号関数内でまだロケール名を処理しません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_LOCALE_NOT_FOUND	TokenNameIdentifier
,	TokenNameCOMMA
"警告: xml:lang={0} のロケールが見つかりませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_CANNOT_MAKE_URL_FROM	TokenNameIdentifier
,	TokenNameCOMMA
"URL を {0} から作成できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_CANNOT_LOAD_REQUESTED_DOC	TokenNameIdentifier
,	TokenNameCOMMA
"要求された doc: {0} をロードできません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_CANNOT_FIND_COLLATOR	TokenNameIdentifier
,	TokenNameCOMMA
"<sort xml:lang={0} のコレーターが見つかりませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_FUNCTIONS_SHOULD_USE_URL	TokenNameIdentifier
,	TokenNameCOMMA
"旧構文: 関数命令では {0} の URL を使用する必要があります。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ENCODING_NOT_SUPPORTED_USING_UTF8	TokenNameIdentifier
,	TokenNameCOMMA
"エンコードはサポートされません: {0} は UTF-8 を使用しています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ENCODING_NOT_SUPPORTED_USING_JAVA	TokenNameIdentifier
,	TokenNameCOMMA
"エンコードはサポートされません: {0} は Java {1} を使用しています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_SPECIFICITY_CONFLICTS	TokenNameIdentifier
,	TokenNameCOMMA
"限定性の矛盾が検出されました: {0} スタイルシート内で最後に検出されたものが使用されます。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_PARSING_AND_PREPARING	TokenNameIdentifier
,	TokenNameCOMMA
"========= {0} を構文解析中および準備中 =========="	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ATTR_TEMPLATE	TokenNameIdentifier
,	TokenNameCOMMA
"属性テンプレート {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:strip-space と xsl:preserve-space の間のマッチングの矛盾"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ATTRIB_NOT_HANDLED	TokenNameIdentifier
,	TokenNameCOMMA
"Xalan はまだ {0} 属性を処理しません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_NO_DECIMALFORMAT_DECLARATION	TokenNameIdentifier
,	TokenNameCOMMA
"10 進数形式の宣言が見つかりません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_OLD_XSLT_NS	TokenNameIdentifier
,	TokenNameCOMMA
"XSLT 名前空間がないか誤っています。 "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED	TokenNameIdentifier
,	TokenNameCOMMA
"デフォルトの xsl:decimal-format 宣言は 1 つしか許可されていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:decimal-format 名は固有でなければなりません。名前 "{0}" が重複していました。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ILLEGAL_ATTRIBUTE	TokenNameIdentifier
...
WG_COULD_NOT_RESOLVE_PREFIX	TokenNameIdentifier
,	TokenNameCOMMA
"名前空間接頭部を解決できませんでした: {0} - ノードは無視されます。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier
...
WG_ILLEGAL_ATTRIBUTE_NAME	TokenNameIdentifier
,	TokenNameCOMMA
"正しくない属性名: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier
,	TokenNameCOMMA
"属性 {0}: {1} に使用された値は正しくありません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_EMPTY_SECOND_ARG	TokenNameIdentifier
,	TokenNameCOMMA
"文書機能の 2 番目の引数から得られた nodeset が空です。空の node-set を戻します。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:processing-instruction 名の 'name' 属性の値は 'xml' であってはなりません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier
,	TokenNameCOMMA
"xsl:processing-instruction の ''name'' 属性の値は有効な NCName でなければなりません: {0}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
WG_ILLEGAL_ATTRIBUTE_POSITION	TokenNameIdentifier
...
NO_MODIFICATION_ALLOWED_ERR	TokenNameIdentifier
,	TokenNameCOMMA
"変更できないオブジェクトを変更しようとしています。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
">>>>>>> Xalan バージョン "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"XSLProcessor: 完了"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_option"	TokenNameStringLiteral
,	TokenNameCOMMA
"Xalan-J コマンド行 Process クラス・オプション"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_option"	TokenNameStringLiteral
...
,	TokenNameCOMMA
"オプション {0} は XSLTC モードではサポートされていません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_invalid_xalan_option"	TokenNameStringLiteral
,	TokenNameCOMMA
"オプション {0} は -XSLTC と一緒にしか使用できません。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_no_input"	TokenNameStringLiteral
,	TokenNameCOMMA
"エラー: スタイルシートがないか入力 xml が指定されていません。使用法の説明については、オプションなしでこのコマンドを実行してください。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_common_options"	TokenNameStringLiteral
,	TokenNameCOMMA
"-共通オプション-"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_xalan_options"	TokenNameStringLiteral
,	TokenNameCOMMA
"-Xalan 用オプション-"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_xsltc_options"	TokenNameStringLiteral
,	TokenNameCOMMA
"-XSLTC 用オプション-"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"xslProc_return_to_continue"	TokenNameStringLiteral
,	TokenNameCOMMA
"(続けるには <return> を押してください)"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXSLTC"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XSLTC (変換に XSLTC を使用)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"   [-PARSER parser liaison の完全修飾クラス名]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionE"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-E (実体参照を展開しない)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"   [-QC (静止パターン矛盾警告)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionQ"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-Q  (静止モード)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionLF"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-LF (LF (改行) を出力時のみに使用  {デフォルトは CR/LF})]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionCR"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-CR (CR (復帰) を出力時のみに使用 {デフォルトは CR/LF})]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"   [-INDENT (字下げするスペースを制御 {デフォルトは 0})]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTT"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TT (テンプレートを呼び出し中にトレース。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTG"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TG (各生成イベントをトレース。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTS"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TS (各選択イベントをトレース。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTTC"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TTC (テンプレートの子を呼び出し中にトレース。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTCLASS"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TCLASS (トレース拡張機能の TraceListener クラス。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionVALIDATE"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-VALIDATE (妥当性検査を実行するかどうかを設定。  デフォルトでは、妥当性検査はオフです。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionEDUMP"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-EDUMP {optional filename} (エラー時に stackdump を実行。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXML"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XML (XML フォーマッターを使用および XML ヘッダーを追加。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionTEXT"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-TEXT (シンプル・テキスト・フォーマッターを使用。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionHTML"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-HTML (HTML フォーマッターを使用。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionPARAM"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-PARAM 名前式 (stylesheet パラメーターを設定。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"noParsermsg1"	TokenNameStringLiteral
,	TokenNameCOMMA
"XSL 処理は成功しませんでした。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"noParsermsg2"	TokenNameStringLiteral
,	TokenNameCOMMA
"** パーサーが見つかりませんでした **"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"noParsermsg3"	TokenNameStringLiteral
,	TokenNameCOMMA
"クラスパスを調べてください。"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"noParsermsg4"	TokenNameStringLiteral
,	TokenNameCOMMA
"IBM の XML Parser for Java がない場合は、次のサイトからダウンロードできます:"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
...
,	TokenNameCOMMA
"   [-URIRESOLVER 絶対クラス名 (URI を解決するために使用する URIResolver)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionENTITYRESOLVER"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-ENTITYRESOLVER 絶対クラス名 (実体を解決するために使用する EntityResolver)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionCONTENTHANDLER"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-CONTENTHANDLER 絶対クラス名 (出力をシリアライズするために使用する ContentHandler)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionLINENUMBERS"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-L ソース・ドキュメントの行番号を使用]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionSECUREPROCESSING"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-SECURE (セキュリティー保護された処理機能を true に設定)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionMEDIA"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-MEDIA mediaType (文書と関連したスタイルシートを検索するメディア属性を使用。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionFLAVOR"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-FLAVOR flavorName (変換を実行するために s2s=SAX または d2d=DOM を明示的に使用。)] "	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionDIAG"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-DIAG (変換にかかった全ミリ秒を印刷。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionINCREMENTAL"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-INCREMENTAL (http://xml.apache.org/xalan/features/incremental を true に設定することにより増分 DTM 構造を要求。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionNOOPTIMIMIZE"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-NOOPTIMIMIZE (http://xml.apache.org/xalan/features/optimize を false に設定することによりスタイルシート最適化処理なしを要求。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionRL"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-RL recursionlimit (スタイルシートの再帰の深さについての数値限界を指定。)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXO"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XO [transletName] (名前を生成後の translet に割り当て)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXD"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XD destinationDirectory (宛先ディレクトリーを translet に指定)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXJ"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XJ jarfile (translet クラスを名前 <jarfile> の JAR ファイルにパッケージします)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXP"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XP package (パッケージ名接頭部をすべての生成後の translet クラスに指定します)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXN"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XN (テンプレートをインラインで使用可能にします)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXX"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XX (追加のデバッグ・メッセージ出力をオンにします)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"optionXT"	TokenNameStringLiteral
,	TokenNameCOMMA
"   [-XT (可能な場合は translet を使用して変換)]"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"diagTiming"	TokenNameStringLiteral
,	TokenNameCOMMA
" --------- {0} の {1} による変換には {2} ミリ秒かかりました"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"recursionTooDeep"	TokenNameStringLiteral
,	TokenNameCOMMA
"テンプレートのネストが深すぎます。 ネスト = {0}、テンプレート {1} {2}"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"nameIs"	TokenNameStringLiteral
,	TokenNameCOMMA
"名前は"	TokenNameStringLiteral
}	TokenNameRBRACE
,	TokenNameCOMMA
{	TokenNameLBRACE
"matchPatternIs"	TokenNameStringLiteral
,	TokenNameCOMMA
"マッチング・パターンは"	TokenNameStringLiteral
}	TokenNameRBRACE
}	TokenNameRBRACE
;	TokenNameSEMICOLON
}	TokenNameRBRACE
